...
def create_post_nodes(folder_name):
    data_path = 'data/processed_data/PHEME/'
    combo_path = 'data/processed_data/PHEME/%s/' % folder_name
    post_text_path = 'data/processed_data/PHEME/text_embeddings/tweet_text/'
